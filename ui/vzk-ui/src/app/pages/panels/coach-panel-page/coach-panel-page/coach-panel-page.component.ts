...
@Component({
  selector: 'app-coach-panel-page',
  templateUrl: './coach-panel-page.component.html',
  styleUrls: ['./coach-panel-page.component.css']
})
export class CoachPanelPageComponent implements OnInit {
  userRole = "";
