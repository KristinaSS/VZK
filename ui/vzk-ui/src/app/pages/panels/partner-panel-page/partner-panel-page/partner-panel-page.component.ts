...
@Component({
  selector: 'app-partner-panel-page',
  templateUrl: './partner-panel-page.component.html',
  styleUrls: ['./partner-panel-page.component.css']
})
export class PartnerPanelPageComponent implements OnInit {
  userRole = "";
  ...
  async ngOnInit() {
    ...
    if (!isLogged || this.userRole != "partner") {
